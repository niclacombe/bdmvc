<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="row">
			...
			<?php echo form_open('inscriptions/searchIndiv'); ?>
        ...
        <?php if (isset($results)): ?>
        	<div class="row">
		    	<div class="col-md-4 col-xs-12">
		    		<select id="selectIdActiv" <?php if($_SESSION['infoUser']->NiveauAcces <= 5): ?> disabled="disabled" <?php endif; ?> class="form-control">
