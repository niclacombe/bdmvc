...
class Courriel extends CI_Controller {
	...
	public function sendEmail(){
		...
		$this->email->from('BD@terres-de-belenos.com', 'Les Terres de Bélénos');
		$this->email->to($destinataires);

		$this->email->subject($sujet);

		$message = "<html><head></head><body style=\"background-image: url('https://www.toptal.com/designers/subtlepatterns/patterns/vintage-concrete.png');\">";
		$message .= '<div style="width:600px; margin: 0 auto;"><table cellpadding="0" cellspacing="0" border="0">';
		$message .= '<tr><td><img src="http://www.terres-de-belenos.com/wp-content/images/logo_belenos.png" alt="logo" style="height:200px; width:auto;"></td></tr>';
		$message .= '<tr><td style="padding-top: 25px; padding-bottom:15px">' .$texte .'</td></tr>';
		$message .= '<tr><td>-----<br><br>' .$signature .'</td></tr>';
        $message .= '</table>';
